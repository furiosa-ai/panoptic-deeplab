...
from detectron2.modeling.postprocessing import sem_seg_postprocess, nearest_postprocess, bicubic_postprocess
...
class PanopticDeepLab(nn.Module):
    ...
    def post_process(self, sem_seg_results, center_results, offset_results, batched_inputs, images):
        ...
        for sem_seg_result, center_result, offset_result, input_per_image, image_size in zip(
            ...
            print("PANOPTIC LABEL LIST (1024, 2048)", torch.unique(panoptic_image))
    ...
    def forward(self, batched_inputs):
        ...
        if self.onnx:
            ...
            #print("INPUT SIZE:", images.tensor.size())
            features = self.backbone(images.tensor)
        losses = {}
        if not self.onnx and "sem_seg" in batched_inputs[0]:
