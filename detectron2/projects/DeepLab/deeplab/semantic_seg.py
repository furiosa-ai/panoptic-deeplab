...
class QConcat(nn.Module):
    def __init__(self, inchannel1, inchannel2, outchannel, kernel_size) -> None:
        super().__init__()
        self.conv1 = nn.Conv2d(inchannel1, outchannel, kernel_size=kernel_size)
        self.conv2 = nn.Conv2d(inchannel2, outchannel, kernel_size=kernel_size)
